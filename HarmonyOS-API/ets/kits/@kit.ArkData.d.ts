...
export { ValueType, ValuesBucket, cloudData, cloudExtension, commonType, dataSharePredicates, distributedDataObject, distributedKVStore, preferences, relationalStore, unifiedDataChannel, uniformTypeDescriptor, uniformDataStruct, sendablePreferences, dataAbility, sendableRelationalStore, intelligence };
